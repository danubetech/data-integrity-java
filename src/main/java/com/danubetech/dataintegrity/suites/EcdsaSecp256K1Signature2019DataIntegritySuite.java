...
public class EcdsaSecp256K1Signature2019DataIntegritySuite extends DataIntegritySuite {
	...
	EcdsaSecp256K1Signature2019DataIntegritySuite() {
		super(
				...
				List.of(DataIntegrityContexts.JSONLD_CONTEXT_W3ID_SECURITY_SUITES_SECP256K1_2019_V1, URI.create("https://www.w3.org/2018/credentials/v1"), DataIntegrityContexts.JSONLD_CONTEXT_W3ID_SECURITY_V3));
	}
}
