...
import com.danubetech.dataintegrity.signer.EcdsaSecp384r1Signature2019LdSigner;
...
public class JsonLdSignEcdsaSecp384r1Signature2019Test {

	@Test
	@SuppressWarnings("unchecked")
	public void testSignEcdsaSecp384r1Signature2019() throws Throwable {

		JsonLDObject jsonLdObject = JsonLDObject.fromJson(new InputStreamReader(Objects.requireNonNull(JsonLdSignEcdsaSecp384r1Signature2019Test.class.getResourceAsStream("input.jsonld"))));
		...
		EcdsaSecp384r1Signature2019LdSigner signer = new EcdsaSecp384r1Signature2019LdSigner(TestKeys.testP384PrivateKey);
		...
		assertEquals(DataIntegritySuites.DATA_INTEGRITY_SUITE_ECDSASECP384R1SIGNATURE2019.getTerm(), dataIntegrityProof.getType());
