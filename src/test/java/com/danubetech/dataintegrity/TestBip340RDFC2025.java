...
public class TestBip340RDFC2025 {
    ...
    public void testSign() throws JsonLDException, GeneralSecurityException, IOException {
        ...
        JsonLDObject jsonLdObject = JsonLDObject.fromJson(new InputStreamReader(Objects.requireNonNull(TestBip340RDFC2025.class.getResourceAsStream("bip340-rdfc-2025.unsigned.json"))));
        jsonLdObject.setDocumentLoader(DOCUMENT_LOADER);

        Map<String, Object> keypair = objectMapper.readValue(new InputStreamReader(Objects.requireNonNull(TestBip340RDFC2025.class.getResourceAsStream("bip340-rdfc-2025.keypair.json"))), Map.class);
    ...
    public void testVerify() throws JsonLDException, GeneralSecurityException, IOException {
        ...
        JsonLDObject jsonLdObject = JsonLDObject.fromJson(new InputStreamReader(Objects.requireNonNull(TestBip340RDFC2025.class.getResourceAsStream("bip340-rdfc-2025.signed.json"))));
        jsonLdObject.setDocumentLoader(DOCUMENT_LOADER);
